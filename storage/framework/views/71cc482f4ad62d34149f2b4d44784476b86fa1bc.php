                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group<?php echo e($errors->has('item_price') ? ' has-danger' : ''); ?>">
                                            <label class="form-control-label" for="item_price"><?php echo e(__('Item Price (No tax included)')); ?></label>
                                       ...
                                       <!--  <?php if($restorant->getConfig('hide_tax_input',"false")!="false"): ?> -->
                                        ...
                                        <?php endif; ?> -->
                                        <?php echo $__env->make('partials.input',['id'=>'vat','name'=>__('VAT percentage( calculated into item price )'),'placeholder'=>__('Item VAT percentage'),'value'=>$restorant->vat==""?$restorant->getConfig('default_tax_value',0):$restorant->vat,'required'=>false,'type'=>'hidden'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\qrmenu\resources\views/items/edit.blade.php ENDPATH**/ ?>