                            ...
                            <div class="col-sm col-md col-lg col-lg" id="modalItemDetailsPart">
                               ...
                               <?php if(  !(isset($canDoOrdering)&&!$canDoOrdering)   ): ?>
                                <div class="quantity-area">
                                    ...
                                    <div class="form-group">
                                         <br />
                                        <label class="form-control-label" for="quantity"><?php echo e(__('Comment')); ?></label>
                                        <textarea name="item_comment" id="item_comment" class="form-control" placeholder="Your comment here ..."></textarea>
                                    </div>
...
<?php /**PATH D:\xampp\htdocs\qrmenu\resources\views/restorants/partials/modals.blade.php ENDPATH**/ ?>