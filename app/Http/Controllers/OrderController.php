...
class OrderController extends Controller
{
    ...
    private function toMobileLike(Request $request){
        ...
        foreach (Cart::getContent() as $key => $item) {
            ...
            array_push($items,array(
                ...
                "qty"=>$item->quantity,
                "item_comment"=>$item->attributes->item_comment,
        ...
        if($request->has('table_id')){
         ...
         /*$checkout_phone_field=null;
         if($request->has('checkout_phone_field')){
             $checkout_phone_field=$request->checkout_phone_field;
         }*/
        $checkout_phone=null;
         if($request->has('checkout_phone')){
             $checkout_phone=$request->checkout_phone;
         }
         
         //Email 
         $checkout_customer_email_field=null;
         if($request->has('checkout_customer_email_field')){
             $checkout_customer_email_field=$request->checkout_customer_email_field;
         }
    ...
    public function store(Request $request){
      ...
      $validatedData = $request->validate([
       ...
       //echo "<pre>";print_r($mobileLikeRequest->toArray());die;
        //Data
            ...
            auth()->user()->hasRole('admin')
                ...
                foreach ($order->items()->get() as $key => $item) {
                    if($item->pivot->id==$request->pivot_id){
                       ...
                       // $oi->item_comment=$request->item_comment;
                        $oi->update();
                ...
                foreach ($order->items()->get() as $key => $item) {
                    ...
                    //$item_comment=$item->pivot->item_comment;
                }
