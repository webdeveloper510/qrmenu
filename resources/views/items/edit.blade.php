                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group{{ $errors->has('item_price') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="item_price">{{ __('Item Price (No tax included)') }}</label>
                                       ...
                                       <!--  @if ($restorant->getConfig('hide_tax_input',"false")!="false") -->
                                        ...
                                        @endif -->
                                        @include('partials.input',['id'=>'vat','name'=>__('VAT percentage( calculated into item price )'),'placeholder'=>__('Item VAT percentage'),'value'=>$restorant->vat==""?$restorant->getConfig('default_tax_value',0):$restorant->vat,'required'=>false,'type'=>'hidden'])
