...
@include('partials.input',['id'=>'vat','name'=>__('VAT percentage( for all menu items )'),'placeholder'=>__('Item VAT percentage'),'value'=>$restorant->vat==""?$restorant->getConfig('default_tax_value',0):$restorant->vat,'required'=>false,'type'=>'number'])
