...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::name('admin.')->group(function () {
        ...
        Route::get('owner_login', 'RestorantController@owner_login')->name('restaurants.owner_login');//added by NG

        Route::post('delete_tips', 'RestorantController@delete_tips')->name('restaurants.delete_tips');//added by NG
